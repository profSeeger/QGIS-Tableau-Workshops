---
title: "Workshop Prerequisites & Preparation"
...
Workshop data will be available via GitHub two days before the session (accessible from the left-hand menu).  
Please install the software and download the data **before** arriving at the workshop.

> **Important:** If you are using a government or employer-issued laptop, IT authorization may be required to install software. Please plan accordingly.
...
Curiosity about maps, data, and visualization is the most important prerequisite!
